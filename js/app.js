...
(function () {
  ...
  function firstAllowedView() {
    ...
    const views = ["dashboard", "wizard", "deal", "appraisal", "market", "leads", "listings", "portfolio", "pms", "assistant", "reports", "transactions", "financing", "users", "admin", "settings"];
  ...
  function render() {
    ...
    hideAuth();
    const title = { dashboard: "Dashboard", wizard: "New Investment", deal: "Deal Analysis", portfolio: "Portfolio", pms: "Property Management", assistant: "AI Assistant", reports: "Reports", appraisal: "Appraisal", market: "Market Scan", listings: "Listings", leads: "CRM / Leads", transactions: "Transactions", financing: "Financing", users: "Users & Access", admin: "Brokerage", settings: "Settings" };
    ...
    $$("#nav .nav-item").forEach(b => {
      ...
      b.classList.toggle("nav-hidden", !navAllowed(view) || (roleIs("broker") && view === "dashboard"));
    });
    ...
    destroyMapPickers();
    const map = { dashboard: renderDashboard, wizard: renderWizard, deal: renderDeal, portfolio: renderPortfolio, pms: renderPMS, assistant: renderAssistant, reports: renderReports, appraisal: renderAppraisal, market: renderMarketScan, listings: renderListings, leads: renderLeads, transactions: renderTransactions, financing: renderFinancing, users: renderUsers, admin: renderAdmin, settings: renderSettings };
